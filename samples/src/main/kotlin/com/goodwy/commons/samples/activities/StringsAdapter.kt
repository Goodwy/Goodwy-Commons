...
import com.goodwy.commons.samples.databinding.ListItemBinding
...
class StringsAdapter(
    ...
    override fun getActionMenuId() = com.goodwy.commons.R.menu.cab_delete_only
    ...
    override fun actionItemPressed(id: Int) {
        ...
        when (id) {
            com.goodwy.commons.R.id.cab_delete -> changeOrder()
        }
    }
