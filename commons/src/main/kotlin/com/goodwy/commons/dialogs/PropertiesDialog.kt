...
import com.goodwy.commons.helpers.sumByInt
import com.goodwy.commons.helpers.sumByLong
...
class PropertiesDialog() {
    ...
    constructor(activity: Activity, path: String, countHiddenItems: Boolean = false) : this() {
        ...
        if (fileDirItem.isDirectory) {
            ...
            if (activity.baseConfig.appId.removeSuffix(".debug") == "com.goodwy.filemanager.pro") {
