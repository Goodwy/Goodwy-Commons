...
open class BaseConfig(val context: Context) {
    ...
    var contactThumbnailsSize: Float
        get() = prefs.getFloat(CONTACT_THUMBNAILS_SIZE, CONTACT_THUMBNAILS_SIZE_MEDIUM) //context.resources.getDimension(R.dimen.normal_icon_size).toInt()
        set(contactThumbnailsSize) = prefs.edit().putFloat(CONTACT_THUMBNAILS_SIZE, contactThumbnailsSize).apply()
}
