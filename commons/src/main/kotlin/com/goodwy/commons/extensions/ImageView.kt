...
fun ImageView.setFillWithStrokeLeft(fillColor: Int, backgroundColor: Int, cornerRadiusSize: Float = 0f) {
    ...
    GradientDrawable().apply {
        ...
        setColor(fillColor)
        setStroke(2, strokeColor)
        val bgDrawable = resources.getColoredDrawableWithColor(R.drawable.picker_old_color_left, fillColor)
...
fun ImageView.setFillWithStrokeRigth(fillColor: Int, backgroundColor: Int, cornerRadiusSize: Float = 0f) {
    ...
    GradientDrawable().apply {
        ...
        setColor(fillColor)
        setStroke(2, strokeColor)
        val bgDrawable = resources.getColoredDrawableWithColor(R.drawable.ic_delta, fillColor)
        background = bgDrawable
